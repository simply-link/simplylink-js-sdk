...
var _currenciesModel = require('../../model/generic/currencies-model');
...
var CurrenciesApi = function (_BaseApi) {
    _inherits(CurrenciesApi, _BaseApi);

    function CurrenciesApi() {
        _classCallCheck(this, CurrenciesApi);

        return _possibleConstructorReturn(this, (CurrenciesApi.__proto__ || Object.getPrototypeOf(CurrenciesApi)).apply(this, arguments));
    }
    ...
    _createClass(CurrenciesApi, [{
        ...
        value: function getDataObject() {
            return new _currenciesModel2.default();
        }
    }]);
